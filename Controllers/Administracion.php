<?php
    Class Administracion extends Controller {
        ...
        public function home(){
            ...
            $data['docentes'] = $this->model->getDatos('docentes');
            $data['asignaturas'] = $this->model->getDatos('asignaturas');
            $data['grados'] = $this->model->getDatos('grados');
            $data['representantes'] = $this->model->getDatos('representantes');
            $data['alumnos'] = $this->model->getDatos('alumnos');
