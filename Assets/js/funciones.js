let tblUsuarios, tblCajas, tblClientes, tblCategorias, tblMedidas;
let tblProductos, tblDetalle, tblHistCompras, tblHistVentas, tblArqueo;
let tblAsignaturas, tblGrados, tblDocentes, tblRepresentantes, tblAlumnos;
let tblAsig_doc;
document.addEventListener("DOMContentLoaded", function () {
    ...
    tblAsignaturas = $('#tblAsignaturas').DataTable({
        ajax: {
            url: base_url + "Asignaturas/listar",
            dataSrc: ''
        },
        columns: [
            {'data': 'id'},
    ...
    dom,
    buttons
    });//Fin de la tabla representantes

    tblRepresentantes = $('#tblAsig_doc').DataTable({
        ajax: {
        url: base_url + "Docentes/asignaturas_docente",
        dataSrc: ''
    },
    columns: [
        {'data': 'id'},
    ...
    dom,
    buttons
    });//Fin de la tabla asignaciones de materias a docentes
...
function btnEditarUser(id) {
    ...
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("rol").classList.add("d-none");
...
function frmAsignatura() {
    document.getElementById("title").textContent = "Nueva Asignatura";
    document.getElementById("btnAccion").textContent = "Registrar";
    document.getElementById("frmAsignatura").reset();
    document.getElementById("id").value = "";
    $('#nueva_asignatura').modal('show');
}
...
function registrarAsignatura(e) {
    ...
    if (asignatura.value == "" || grado.value == "") {
        alertas('Todo los campos son obligatorios', 'warning');
    } else {
        const url = base_url + "Asignaturas/registrar";
        const frm = document.getElementById("frmAsignatura");
        const http = new XMLHttpRequest();
        http.open("POST", url, true);
        http.send(new FormData(frm));
        http.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                const res = JSON.parse(this.responseText);
                $('#nueva_asignatura').modal("hide");
                alertas(res.msg, res.icono);
                tblAsignaturas.ajax.reload();
            }
        }
    }
}

function btnEditarAsignatura(id) {
    document.getElementById("title").innerHTML = "Actualizar Asignatura";
    document.getElementById("btnAccion").innerHTML = "Modificar";
    const url = base_url + "Asignaturas/editar/"+id;
    const http = new XMLHttpRequest();
    http.open("GET", url, true);
    http.send();
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            const res = JSON.parse(this.responseText);
            document.getElementById("id").value = res.id;
            document.getElementById("asignatura").value = res.nombre;
            document.getElementById("grado").value = res.id_grado;
            $('#nueva_asignatura').modal('show');
        }
    }
}
...
function frmGrado() {
    document.getElementById("title").textContent = "Nuevo Grado";
    document.getElementById("btnAccion").textContent = "Registrar";
    document.getElementById("frmGrado").reset();
    document.getElementById("id").value = "";
    $('#nuevo_grado').modal('show');
}

function registrarGrado(e) {
    e.preventDefault();
    const nombre = document.getElementById("nombre");
    if (nombre.value == "") {
        alertas('Todo los campos son obligatorios', 'warning');
        ...
        const frm = document.getElementById("frmGrado");
        const http = new XMLHttpRequest();
        http.open("POST", url, true);
        http.send(new FormData(frm));
        http.onreadystatechange = function () {
...
function btnEditarGrado(id) {
    document.getElementById("title").innerHTML = "Actualizar Grado";
    document.getElementById("btnAccion").innerHTML = "Modificar";
...
function registrarDocente(e) {
    ...
    const anio_grad = document.getElementById("anio_grad");
    if (fe_nac.value == "" || titulo.value == "" || institucion.value == "" || anio_grad.value == "") {
        alertas('Todo los campos son obligatorios', 'warning');
    } else {
        const url = base_url + "Docentes/registrar";
        const frm = document.getElementById("frmDocente");
        const http = new XMLHttpRequest();
        http.open("POST", url, true);
        http.send(new FormData(frm));
        http.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                const res = JSON.parse(this.responseText);
                $("#nuevo_docente").modal("hide");
                alertas(res.msg, res.icono);
                tblDocentes.ajax.reload();
            }
        }
    }
}

function btnEditarDocente(id) {
    document.getElementById("title").innerHTML = "Actualizar Docente";
    document.getElementById("btnAccion").innerHTML = "Modificar";
    const url = base_url + "Docentes/editar/" + id;
    const http = new XMLHttpRequest();
    http.open("GET", url, true);
    http.send();
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            const res = JSON.parse(this.responseText);
            document.getElementById("id").value = res.id;
            document.getElementById("fe_nac").value = res.fe_nac;
            document.getElementById("titulo").value = res.titulo;
            document.getElementById("institucion").value = res.institucion;
            document.getElementById("anio_grad").value = res.anio_grad;
            $('#nuevo_docente').modal('show');
        }
    }
}
//Fin Docentes
...
function registrarRepresentante(e) {
    ...
    if (fe_nac.value == "" || cedula.value == "" || direccion.value == "" || telefono.value == "") {
        alertas('Todo los campos son obligatorios', 'warning');
    } else {
        const url = base_url + "Representantes/registrar";
...
function btnEditarRepresentante(id) {
    document.getElementById("title").innerHTML = "Actualizar Representante";
    document.getElementById("btnAccion").innerHTML = "Modificar";
...
function frmAlumno() {
    document.getElementById("title").textContent = "Nuevo Alumno";
    document.getElementById("btnAccion").textContent = "Registrar";
    document.getElementById("frmAlumno").reset();
    document.getElementById("id").value = "";
    $('#nuevo_alumno').modal('show');
}
...
function registrarAlumno(e) {
    ...
    if (nombre.value == "" || fe_nac.value == "" || sexo.value == "" || rep_id.value == "") {
        alertas('Todo los campos son obligatorios', 'warning');
    } else {
...
function btnEditarAlumno(id) {
    document.getElementById("title").innerHTML = "Actualizar Alumno";
    document.getElementById("btnAccion").innerHTML = "Modificar";
    const url = base_url + "Alumnos/editar/"+id;
    const http = new XMLHttpRequest();
    http.open("GET", url, true);
    http.send();
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("rep_id").value = res.id_representante;
            $('#nuevo_alumno').modal('show');
        }
    }
}
...
function btnEliminarAlumno(id) {
    Swal.fire({
        title: 'Esta seguro?',
        text: "El Alumno sera Inactivado!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            const url = base_url + "Alumnos/eliminar/" + id;
            const http = new XMLHttpRequest();
            http.open("GET", url, true);
            http.send();
            http.onreadystatechange = function () {
...
function btnReingresarAlumno(id) {
    Swal.fire({
        title: 'Esta seguro de Reactivar?',
        icon: 'warning',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            const url = base_url + "Alumnos/reingresar/" + id;
            const http = new XMLHttpRequest();
            http.open("GET", url, true);
            http.send();
            http.onreadystatechange = function () {
...
function establecerAsignaturas(e) {
    e.preventDefault();
    const url = base_url + "Docentes/establecerAsignaturas";
    const frm = document.getElementById('frmEstAsig');
    const http = new XMLHttpRequest();
    http.open("POST", url, true);
    http.send(new FormData(frm));
    http.onreadystatechange = function () {
