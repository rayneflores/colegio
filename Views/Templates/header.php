...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php echo base_url; ?>Administracion/home">SysEduca</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseDocentes" aria-expanded="false" aria-controls="collapseDocentes">
                                <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap fa-2x text-success"></i></div>
                                Docentes
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseDocentes" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo base_url; ?>Docentes/asignaturas"><i class="fas fa-truck text-success"></i> &nbsp;&nbsp;Asignaturas</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Docentes/historialC"><i class="fas fa-bread-slice text-success"></i> &nbsp;&nbsp;Historico</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo base_url; ?>Usuarios"><i class="fas fa-users text-success"></i> &nbsp;&nbsp;Usuarios</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Representantes"><i class="fas fa-user-tie text-success"></i> &nbsp;&nbsp;Representantes</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Alumnos"><i class="fas fa-user-graduate text-success"></i> &nbsp;&nbsp;Alumnos</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Docentes"><i class="fas fa-graduation-cap text-success"></i> &nbsp;&nbsp;Docentes</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Asignaturas"><i class="fas fa-book text-success"></i>&nbsp;&nbsp;Asignaturas</a>
                                    <a class="nav-link" href="<?php echo base_url; ?>Grados"><i class="fas fa-list-ol text-success"></i>&nbsp;&nbsp;Grados</a>
